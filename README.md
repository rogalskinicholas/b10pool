...
Row Level Security: anyone can browse rides, but contact details and private profile fields are only selectable by signed-in users (column-level grants). Only the driver can update or delete their own rides.
